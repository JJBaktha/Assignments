...
pool_length = float ( input ( " Please enter the length of your pool in meters : " ))
pool_width = float ( input ( " Please enter the width of your pool in meters : " ))
deep_depth = float ( input ( " Please enter the depth of your pool at the deep end in meters: " ))
shallow_depth = float ( input ( " Please enter the depth of your pool at the shallow end in meters: " ))
