...
lawn_width = float ( input ( " Please enter the width of your lawn including the border : " )) - 2
lawn_length = float ( input ( " Please enter the length of your lawn including the border : " )) - 2
